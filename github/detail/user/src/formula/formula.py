...
headers = {'Content-Type': 'application/json', 'User-Agent': 'Code Labs Zup', 'Accept': 'application/vnd.github.v3+json'}

def run(username, repo_details, user, key):
    # Print User details
    try:
    ...
    if user_details is not None:
        ...
        # Convert to utf-8 encoded JSON string
